...
<div id="sermons" class="uk-form" v-cloak>
  ...
  <div class="uk-margin uk-flex uk-flex-space-between uk-flex-wrap" data-uk-margin>
    <div class="uk-flex uk-flex-middle uk-flex-wrap" data-uk-margin>
      ...
      <h2 class="uk-margin-remove" v-if="!selected.length">
        {{ '{0} %count% Sermons|{1} %count% Sermon|]1,Inf[ %count% Sermons' | transChoice count {count:count} }}
      </h2>

      <template v-else>
        <h2 class="uk-margin-remove">
          {{ '{1} %count% Sermon selected|]1,Inf[ %count% Sermons selected' | transChoice selected.length {count:selected.length} }}
        </h2>
    ...
    <div data-uk-margin>
      ...
      <a class="uk-button uk-button-primary" :href="$url.route('admin/sermons/sermon/edit')">
        {{ 'Add Sermon' | trans }}
      </a>
  ...
  <div class="uk-overflow-container">
    <table class="uk-table uk-table-hover uk-table-middle">
      ...
      <tr>
        ...
        <th class="pk-table-width-200 pk-table-min-width-200">
          {{ 'URL' | trans }}
        </th>
      </tr>
      </thead>
      ...
      <tr class="check-item" v-for="sermon in sermons" :class="{'uk-active': active(sermon)}">
        <td>
          <input type="checkbox" name="id" :value="sermon.id">
        </td>
        <td>
  ...
  <h3 class="uk-h1 uk-text-muted uk-text-center" v-show="sermons && !sermons.length">
    {{ 'No sermons found.' | trans }}
  </h3>
